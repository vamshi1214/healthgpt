...
from core import doctor_finder_service
...
async def doctor_finder_service_find_doctors(body: BodyDoctorFinderServiceFindDoctors = Body(...)) -> FindDoctorsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(doctor_finder_service.find_doctors, query=body.query, user_location=body.user_location, user_latitude=body.user_latitude, user_longitude=body.user_longitude, max_distance_miles=body.max_distance_miles, insurance_provider=body.insurance_provider)
    return response
...
async def doctor_finder_service_get_doctor_details(body: BodyDoctorFinderServiceGetDoctorDetails = Body(...)) -> GetDoctorDetailsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(doctor_finder_service.get_doctor_details, doctor_id=body.doctor_id)
    return response
...
async def doctor_finder_service_get_doctor_reviews(body: BodyDoctorFinderServiceGetDoctorReviews = Body(...)) -> GetDoctorReviewsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(doctor_finder_service.get_doctor_reviews, doctor_id=body.doctor_id, limit=body.limit)
    return response
...
async def doctor_finder_service_book_appointment(body: BodyDoctorFinderServiceBookAppointment = Body(...)) -> BookAppointmentOutputSchema:
    ...
    """
    response = await run_sync_in_thread(doctor_finder_service.book_appointment, doctor_id=body.doctor_id, patient_name=body.patient_name, patient_email=body.patient_email, patient_phone=body.patient_phone, appointment_datetime=body.appointment_datetime, chief_complaint=body.chief_complaint, appointment_type=body.appointment_type, visit_type=body.visit_type, insurance_provider=body.insurance_provider, insurance_plan=body.insurance_plan, source_query_id=body.source_query_id)
    return response
...
async def doctor_finder_service_get_available_slots(body: BodyDoctorFinderServiceGetAvailableSlots = Body(...)) -> GetAvailableSlotsOutputSchema:
    ...
    """
    response = await run_sync_in_thread(doctor_finder_service.get_available_slots, doctor_id=body.doctor_id, start_date=body.start_date, end_date=body.end_date)
    return response
...
async def doctor_finder_service_submit_doctor_review(body: BodyDoctorFinderServiceSubmitDoctorReview = Body(...)) -> SubmitDoctorReviewOutputSchema:
    ...
    """
    response = await run_sync_in_thread(doctor_finder_service.submit_doctor_review, doctor_id=body.doctor_id, appointment_id=body.appointment_id, overall_rating=body.overall_rating, review_text=body.review_text, patient_name=body.patient_name, condition_treated=body.condition_treated, would_recommend=body.would_recommend)
    return response
